...
public class Board extends JPanel {
  ...
  public void newIteration(){
    ...
    for(int i=0;i<Constants.NUMBER_OF_ROWS*Constants.NUMBER_OF_COLUMNS;i++){
      ...
      if( i<=Constants.NUMBER_OF_ROWS-1 || i>((Constants.NUMBER_OF_ROWS-1)*Constants.NUMBER_OF_COLUMNS-1) || (i % Constants.NUMBER_OF_ROWS)-(Constants.NUMBER_OF_ROWS-1)==0 || i%Constants.NUMBER_OF_ROWS==0  ) continue;
